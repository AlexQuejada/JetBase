...
export const RowContextMenu: React.FC<RowContextMenuProps> = ({
  ...
  return (
    ...
    >
      ...
      <button onClick={() => onEditRowName(contextMenu.rowIdx!)} className="w-full text-left px-3 py-2 hover:bg-gray-100 text-sm flex items-center gap-2">
...
export const ColumnContextMenu: React.FC<ColumnContextMenuProps> = ({
  ...
  return (
    ...
    >
      ...
      <button onClick={() => onRenameColumn(columnContextMenu.colIdx!)} className="w-full text-left px-3 py-2 hover:bg-gray-100 text-sm flex items-center gap-2">
